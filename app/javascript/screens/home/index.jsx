...
const ButtonSubscribe = styled.a`
  border-width: 2px;
  margin-top: 30px;
`
  ...
  return (
    <SectionWrapper>
      ...
      <Columns className='is-centered is-mobile'>
        <Columns.Column mobile={{ size: 9, offset: 1 }} desktop={{ size: 4, offset: 2 }}>
      ...
      <Columns className='has-text-centered'>
        <Columns.Column>
          <ButtonSubscribe href='users/sign_up' className='button is-success is-outlined is-large has-text-white'>CADASTRAR AGORA</ButtonSubscribe>
        </Columns.Column>
      </Columns>
    </SectionWrapper>
  )
